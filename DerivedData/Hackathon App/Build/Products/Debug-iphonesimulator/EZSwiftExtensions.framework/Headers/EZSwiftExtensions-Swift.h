...
- (nullable instancetype)initFromString:(NSString * _Nonnull)string format:(NSString * _Nonnull)format;

/// EZSE: Converts NSDate to String
- (NSString * _Nonnull)toStringWithDateStyle:(NSDateFormatterStyle)dateStyle timeStyle:(NSDateFormatterStyle)timeStyle;

/// EZSE: Converts NSDate to String, with format
- (NSString * _Nonnull)toStringWithFormat:(NSString * _Nonnull)format;

/// EZSE: Calculates how many days passed from now to date
- (double)daysInBetweenDate:(NSDate * _Nonnull)date;

/// EZSE: Calculates how many hours passed from now to date
- (double)hoursInBetweenDate:(NSDate * _Nonnull)date;

/// EZSE: Calculates how many minutes passed from now to date
- (double)minutesInBetweenDate:(NSDate * _Nonnull)date;

/// EZSE: Calculates how many seconds passed from now to date
- (double)secondsInBetweenDate:(NSDate * _Nonnull)date;

/// EZSE: Easy creation of time passed String. Can be Years, Months, days, hours, minutes or seconds
- (NSString * _Nonnull)timePassed;
@end
...
+ (NSTimer * _Nonnull)runThisEveryWithSeconds:(NSTimeInterval)seconds handler:(void (^ _Nonnull)(NSTimer * _Null_unspecified))handler;
...
@interface NSURL (SWIFT_EXTENSION(EZSwiftExtensions))

/// EZSE: Returns convert query to Dictionary
@property (nonatomic, readonly, copy) NSDictionary<NSString *, NSString *> * _Nullable queryParameters;
@end
...
/// EZSwiftExtensions
- (nonnull instancetype)initWithX:(CGFloat)x y:(CGFloat)y w:(CGFloat)w h:(CGFloat)h target:(id _Nonnull)target action:(SEL _Null_unspecified)action;
...
- (void)addTapGestureWithTapNumber:(NSInteger)tapNumber target:(id _Nonnull)target action:(SEL _Null_unspecified)action;
...
/// EZSwiftExtensions
- (void)addSwipeGestureWithDirection:(UISwipeGestureRecognizerDirection)direction numberOfTouches:(NSInteger)numberOfTouches target:(id _Nonnull)target action:(SEL _Null_unspecified)action;
...
/// EZSwiftExtensions
- (void)addPanGestureWithTarget:(id _Nonnull)target action:(SEL _Null_unspecified)action;

/// EZSwiftExtensions - Make sure you use  "[weak self] (gesture) in" if you are using the keyword self inside the closure or there might be a memory leak
- (void)addPanGestureWithAction:(void (^ _Nullable)(UIPanGestureRecognizer * _Nonnull))action;

/// EZSwiftExtensions
- (void)addPinchGestureWithTarget:(id _Nonnull)target action:(SEL _Null_unspecified)action;

/// EZSwiftExtensions - Make sure you use  "[weak self] (gesture) in" if you are using the keyword self inside the closure or there might be a memory leak
- (void)addPinchGestureWithAction:(void (^ _Nullable)(UIPinchGestureRecognizer * _Nonnull))action;

/// EZSwiftExtensions
- (void)addLongPressGestureWithTarget:(id _Nonnull)target action:(SEL _Null_unspecified)action;
...
- (void)addNotificationObserver:(NSString * _Nonnull)name selector:(SEL _Null_unspecified)selector;
